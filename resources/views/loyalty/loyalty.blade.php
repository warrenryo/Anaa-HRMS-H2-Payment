  ...
  <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
    ...
    <div class="group flex flex-col h-full bg-white border border-gray-200 shadow-sm rounded-xl dark:bg-slate-900 dark:border-gray-700 dark:shadow-slate-700/[.7]">
      ...
      <div class="text-center p-4 md:p-6">
        ...
        Reduction/Decrease in the price of a room offered in Anaa
    ...
    <br> </br>
      ...
      <a href="{{ url('dashboard') }}" class="text-blue-700 w-40 hover:text-white border border-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-20 py-2 text-center me-2 mb-2 dark:border-blue-500 dark:text-white-500 dark:hover:text-white dark:hover:bg-blue-600 dark:focus:ring-blue-800">REDEEM</a>  
      </div>
    ...
    <div class="group flex flex-col h-full bg-white border border-gray-200 shadow-sm rounded-xl dark:bg-slate-900 dark:border-gray-700 dark:shadow-slate-700/[.7]">
      ...
      <div class="text-center p-4 md:p-6">
        ...
        <p class="mt-3 text-gray-500">
        Extend their stay beyond the standard check-out time for free
        </p>
      </div>
      ...
      <div class="text-center">
      <a href="{{ url('dashboard') }}" class="text-red-700 w-40 hover:text-white border border-red-700 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-sm px-20 py-2 text-center me-2 mb-2 dark:border-red-500 dark:text-white-500 dark:hover:text-white dark:hover:bg-red-600 dark:focus:ring-red-800">REDEEM</a>  
      </div>
    ...
    <div class="group flex flex-col h-full bg-white border border-gray-200 shadow-sm rounded-xl dark:bg-slate-900 dark:border-gray-700 dark:shadow-slate-700/[.7]">
      ...
      <div class="text-center p-4 md:p-6">
        ...
        <p class="mt-3 text-gray-500">
        Stay for a certain number of nights without paying for accommodation
        </p>
      ...
      <div class="text-center">
      <a href="{{ url('dashboard') }}" class="text-yellow-400 w-40 hover:text-white border border-yellow-400 hover:bg-yellow-500 focus:ring-4 focus:outline-none focus:ring-yellow-300 font-medium rounded-lg text-sm px-20 py-2 text-center me-2 mb-2 dark:border-yellow-300 dark:text-yellow-300 dark:hover:text-white dark:hover:bg-yellow-400 dark:focus:ring-yellow-900">REDEEM</a>  
      </div>
    ...
    <div class="group flex flex-col h-full bg-white border border-gray-200 shadow-sm rounded-xl dark:bg-slate-900 dark:border-gray-700 dark:shadow-slate-700/[.7]">
      ...
      <div class="text-center p-4 md:p-6">
        ...
        <p class="mt-3 text-gray-500">
        Reduction in the price of food and beverages offered by a restaurant of Anaa
        </p>
      </div>
    ...
    <div class="group flex flex-col h-full bg-white border border-gray-200 shadow-sm rounded-xl dark:bg-slate-900 dark:border-gray-700 dark:shadow-slate-700/[.7]">
      ...
      <div class="text-center p-4 md:p-6">
        ...
        <p class="mt-3 text-gray-500">
        Providing complimentary meals and beverages in the Anaa for free
        </p>
      </div>
    ...
    <div class="group flex flex-col h-full bg-white border border-gray-200 shadow-sm rounded-xl dark:bg-slate-900 dark:border-gray-700 dark:shadow-slate-700/[.7]">
      ...
      <div class="text-center p-4 md:p-6">
        ...
        <p class="mt-3 text-gray-500">
        Special benefits or offers extended to guests who are celebrating their birthday
        </p>
      </div>
...
<div class="group flex flex-col h-full bg-white border border-gray-200 shadow-sm rounded-xl dark:bg-slate-900 dark:border-gray-700 dark:shadow-slate-700/[.7]">
      ...
      <span class="block mb-1 text-xs font-semibold uppercase text-blue-600 dark:text-blue-500">
        ...
        <p class="mt-3 text-gray-500">
        Use the pool without having to pay an additional fee beyond their room rate
        </p>
    ...
    <div class="group flex flex-col h-full bg-white border border-gray-200 shadow-sm rounded-xl dark:bg-slate-900 dark:border-gray-700 dark:shadow-slate-700/[.7]">
      ...
      <span class="block mb-1 text-xs font-semibold uppercase text-rose-600 dark:text-rose-500">
        ...
        <p class="mt-3 text-gray-500">
        Use the Gym Facility without having to pay additional cost
        </p>
    ...
    <div class="group flex flex-col h-full bg-white border border-gray-200 shadow-sm rounded-xl dark:bg-slate-900 dark:border-gray-700 dark:shadow-slate-700/[.7]">
      ...
      <div class="text-center p-4 md:p-6">
        ...
        <h3 class="text-xl font-semibold text-gray-800 dark:text-gray-300 dark:hover:text-white">
        Priority in Restaurant Queue
        </h3>
        <p class="mt-3 text-gray-500">
        Giving special attention and preference to customers who are considered VIPs
        </p>
